# Initial version written by Zhiying Li, modified/updated by Yingjin
...
dataX = "../faaa/lstm-faaa-LBtest01-6-31g.txt"

# Practical usage
outfile = "../loadbalance/loadbalance-LBtest01" + "_" + str(nnode)
write_outfile = True
...
# ideal(frags, nnode, outfile, write_outfile)  #生成greedy解决方案
