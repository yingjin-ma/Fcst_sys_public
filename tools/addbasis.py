...
folder1 = "/home/yingjin/Work/Fcst_sys_public/database/rawdata/G09data.01.updated/B3LYP_6-31g"
                    ...
                    for line1 in lines1:
                        ...
                        if i0>4 : 
                            if len(line1.split())>15:
                                ...
                                #print(bs_str) 
                                ao1=bs_str.split()[6].strip('(').strip(')').split(',')
                                ao2=bs_str.split()[8].strip('[').strip(']').split(',')
                                #print("ao1",ao1) 
                                #print("ao2",ao2) 
                                n2=len(ao2)
                                for n in range(n2):
